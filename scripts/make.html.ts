...
const makeHtml = (file, mode, menuOriginal, menuRevisited, html) => {
  return dedent.withOptions({ alignValues: true })`
    ...
    <style>
    body { font-family: sans-serif; font-size: 1rem; padding: 2rem; background: #eee; }
    ...
    pre { background: #f5f5f5; font-size: .85rem; }
    ...
    table { border-collapse: collapse; background: #f5f5f5; }
