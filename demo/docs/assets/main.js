...
`,
        ...
        t.TokenSet.Builder.prototype.minimize = function(e) {
          for (var n = this.uncheckedNodes.length - 1; n >= e; n--) {
            ...
            i in this.minimizedNodes
              ...
              : (r.child._str = i, this.minimizedNodes[i] = r.child), this.uncheckedNodes.pop();
          }
        };
      t.Index = function(e) {
        ...
        t.Index.prototype.query = function(e) {
          ...
          var u = Object.keys(r), y = [], P = Object.create(null);
          if (n.isNegated()) {
        ...
        t.Index.prototype.toJSON = function() {
          var e = Object.keys(this.invertedIndex).sort().map(function(r) {
          ...
          e.version != t.version
            && t.utils.warn(
              "Version mismatch when loading serialised index. Current version of lunr '"
                + t.version + "' does not match serialized index '" + e.version + "'",
            );
      ...
      t.Builder = function() {
        ...
        t.Builder.prototype.add = function(e, n) {
          var r = e[this._ref], i = Object.keys(this._fields);
        ...
        t.Query.prototype.clause = function(e) {
          return "fields" in e || (e.fields = this.allFields),
            ...
            e.wildcard & t.Query.wildcard.LEADING && e.term.charAt(0) != t.Query.wildcard
            && (e.term = "*" + e.term),
            e.wildcard & t.Query.wildcard.TRAILING && e.term.slice(-1) != t.Query.wildcard
            && (e.term = "" + e.term + "*"),
        ...
        t.QueryLexer.prototype.sliceString = function() {
          ...
          return e.push(this.str.slice(n, this.pos)),
        ...
        t.QueryLexer.prototype.acceptDigitRun = function() {
          var e, n;
          do e = this.next(), n = e.charCodeAt(0); while (n > 47 && n < 58);
          ...
          if (n != null) {
            switch (n.type) {
              ...
              default:
                ...
                throw n.str.length >= 1 && (r += " with value '" + n.str + "'"),
        ...
        t.QueryParser.parseField = function(e) {
          ...
          if (n != null) {
            if (e.query.allFields.indexOf(n.str) == -1) {
              var r = e.query.allFields.map(function(o) {
                  return "'" + o + "'";
                }).join(", "),
  ...
  var Z = class {
    ...
    ensureActivePageVisible() {
      let e = document.querySelector(".tsd-navigation .current"), n = e?.parentElement;
    ...
    updateIndexVisibility() {
      let e = document.querySelector(".tsd-index-content"), n = e?.open;
      e && (e.open = !0),
        document.querySelectorAll(".tsd-index-section").forEach(r => {
          r.style.display = "block";
          let i = Array.from(r.querySelectorAll(".tsd-index-link")).every(s =>
            s.offsetParent == null
          );
    ...
    ensureFocusedElementVisible() {
      if (
        ...
        && (this.alwaysVisibleMember.classList.remove("always-visible"),
          ...
          this.alwaysVisibleMember = null), !location.hash
      ) return;
      let e = document.getElementById(location.hash.substring(1));
      if (!e) return;
  ...
  function xe(t, e) {
    t.addEventListener("animationend", () => {
      ...
      e?.closeOnClick && document.addEventListener("click", n => {
...
`,
  ...
  function ot(t, e) {
    ...
    o.addEventListener("click", a),
      ...
      n.addEventListener("keydown", l => {
        ...
        let d = n.getAttribute("aria-activedescendant"), f = d ? document.getElementById(d) : null;
        if (f) {
          let p = !1, v = !1;
          switch (l.key) {
            case "Home":
    ...
    n.addEventListener("change", c),
      ...
      document.body.addEventListener("keydown", l => {
        ...
        let d = l.ctrlKey && l.key === "k", f = !l.ctrlKey && !ut() && l.key === "/";
  ...
  function at(t, e, n, r) {
    ...
    for (let a = 0; a < s.length; a++) {
      ...
      && (d *= 10 / (1 + Math.abs(l.name.length - i.length))), c.score *= d;
    }
    ...
    for (let a = 0; a < o; a++) {
      let c = r.data.rows[Number(s[a].ref)],
        d =
          `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon" aria-label="${
            window.translations[`kind_${c.kind}`].replaceAll("\"", "&quot;")
          }"><use href="#icon-${c.icon || c.kind}"></use></svg>`,
        f = Ce(c.name, i);
      globalThis.DEBUG_SEARCH_WEIGHTS && (f += ` (score: ${s[a].score.toFixed(2)})`),
        c.parent && (f = `<span class="parent">
  ...
  function Te(t, e, n, r) {
    ...
    if (
      r === 1
        ...
        : i = n?.previousElementSibling || t.lastElementChild, i !== n
    ) {
      if (!i || i.role !== "option") {
  ...
  function Ce(t, e) {
    if (e === "") return t;
    let n = t.toLocaleLowerCase(), r = e.toLocaleLowerCase(), i = [], s = 0, o = n.indexOf(r);
    for (; o != -1;) {
  ...
  Oe && "ontouchstart" in document.documentElement
  ...
  var ue = new Map(),
    ...
    ie = class extends I {
      constructor(e) {
        super(e);
        let n = this.el.querySelector("summary"), r = n.querySelector("a");
        r && r.addEventListener("click", () => {
          location.assign(r.href);
        });
        let i = `tsd-accordion-${
            n.dataset.key ?? n.textContent.trim().replace(/\s+/g, "-").toLowerCase()
          }`,
          s;
  ...
  function De(t, e, n) {
    if (t.path) {
      ...
      if (
        r.href = se + t.path,
          n && (r.className = n),
          location.pathname === r.pathname && !r.href.includes("#")
          && (r.classList.add("current"), r.ariaCurrent = "page"),
          t.kind
      ) {
        let i = window.translations[`kind_${t.kind}`].replaceAll("\"", "&quot;");
        r.innerHTML =
          `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon" aria-label="${i}"><use href="#icon-${
            t.icon || t.kind
          }"></use></svg>`;
      }
      ...
      r.innerHTML =
        `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon" aria-label="${i}"><use href="#icon-folder"></use></svg>`,
        r.appendChild(Fe(t.text, document.createElement("span")));
    }
  }
  function Fe(t, e) {
  ...
  function je(t, e, n, r = new Set()) {
    if (r.has(e)) return;
    r.add(e);
    let i = t.reflections[e], s = document.createElement("li");
  ...
  function mt(t, e, n) {
    if (e === n) return !0;
    let r = new Set(), i = [t.reflections[e]];
    for (; i.length;) {
      let s = i.pop();
      if (!r.has(s)) {
        r.add(s);
  ...
  function gt() {
    ...
    return t.setAttribute("width", "20"),
